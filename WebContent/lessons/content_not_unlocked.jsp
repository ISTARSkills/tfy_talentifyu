...
<body style="background-color: RGb(51,51,51);">
	...
	<div class="reveal">
		<div class="slides">
			<section id="content">
				<div  style="    background-repeat: no-repeat; background-image: url('/images/content_not_unlocked.png'); background-size: contain; height: 200vh; zoom: 165%; margin-left: -6%; margin-top: -23%; margin-right: -6%;"> </div>
			</section>
		</div>
	</div>
